...
from .ai_models import ProviderStatus, ProvidersOverview
...
class ProviderCache:
    ...
    def get(self, provider_id: str, suffix: str = "") -> Optional[Any]:
    ...
    def set(self, provider_id: str, value: Any, ttl: Optional[float] = None, suffix: str = ""):
        """Set value in cache."""
        if ttl is None:
    ...
    def get_providers_overview(self) -> Optional[list[ProviderInfo]]:
